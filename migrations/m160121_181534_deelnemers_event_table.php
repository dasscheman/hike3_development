...
class m160121_181534_deelnemers_event_table extends Migration
{
    public function up()
    {
         ...
         * In de tabel tbl_deelnemers_event is een lijst van events met 
         * deelnemers. Een deelnemer kan maar 1 keer per event voorkomen. En 
         * een deelnemer heeft een rol. Deze rol bepaald wat een deelnemer kan 
         * doen als hij ingelogd is.
         */
        /* 
