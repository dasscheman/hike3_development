...
class m160121_075552_event_name_table extends Migration
{
    public function up()
    {
        /*********************** table event_names ****************************/
        /**********************************************************************/
        /* De tabel tbl_events bevat alle hike georganiseerd. Elk event heeft 
         * een startdatum een einddatum en een status. de status kan zijn: 
         * opstart, gestart, beindigd, geannuleerd. 
        /**********************************************************************/
