    ...
    public function getData()
    {
        ...
        foreach ($bonuspunten as $bonuspunt) {
            ...
            $data[] = [
                ...
                'title' => Yii::t('app', 'Ontvangen bonuspunten'),
        ...
        foreach ($qrchecks as $qrcheck) {
            ...
            $data[] = [
                ...
                'title' => Yii::t('app', 'Stillepost gescand'),
        ...
        foreach ($timetrailchecks as $timetrailcheck) {
            ...
            $data[] = [
                ...
                'title' => Yii::t('app', 'Tijdrit gescand'),
        ...
        foreach ($answers as $answer) {
            ...
            $data[] = [
                ...
                'title' => Yii::t('app', 'Vraag beantwoord'),
