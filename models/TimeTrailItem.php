...
class TimeTrailItem extends HikeActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'time_trail_item_name' => Yii::t('app', 'Tijdrit item titel'),
            'code' => Yii::t('app', 'Tijdrit code'),
            'event_ID' => Yii::t('app', 'Event  ID'),
            'volgorde' => Yii::t('app', 'Volgorde'),
            'score' => Yii::t('app', 'Score'),
            'instrction' => Yii::t('app', 'Instructie'),
            'max_time' => Yii::t('app', 'Max tijd'),
